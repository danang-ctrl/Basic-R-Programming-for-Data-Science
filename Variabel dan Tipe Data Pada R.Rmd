...
author: "danang/PSDS Matematika UAD"
date: "3/23/2021"
output: html_document
---
![](/home/dn/Documents/kuliah/psds/Header KD 0202.png)
...
```{r}
vektor_numerik <- c(3, 2, 4)
vektor_character <- c("p","q","r")
```
...
A <- matrix(c(1,3,4,6), #Vektor elemen matriks
            2,               #Jumlah baris
            2)               #Jumlah kolom
A
```
